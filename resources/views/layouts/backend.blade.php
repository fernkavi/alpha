            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#searchshowSubmenu" data-toggle="collapse" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="nav-icon fa fa-cogs"></i> Search/Show
                            </a>
                            <ul class="collapse list-unstyled" id="searchshowSubmenu">
                                <li><a href="#">All Devices</a></li>
                                <li><a href="#">Devices By Node</a></li>
                                <li><a href="#">Devices By Device's Type</a></li>
                                <li><a href="#">Down Devices</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            {{-- <a href="dashboard" class="nav-link">
                                <i class="nav-icon fa fa-cogs"></i> Management
                            </a> --}}
                            <a href="#manageSubmenu" data-toggle="collapse" aria-expanded="false" class="nav-link dropdown-toggle">
                                <i class="nav-icon fa fa-cogs"></i> Management
                            </a>
